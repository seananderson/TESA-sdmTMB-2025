...
grid$year_scaled <- (grid$year - mean(pcod$year)) / sd(pcod$year)
p <- predict(fit, grid)
...
# Coastwide Pacific Spiny Dogfish local trends
...
* You likely *do* want the same coefficient in the main `formula` effects
...
* You can have multiple SVCs
--

* Creative use of factors in the `spatial_varying` argument lets you fit multiple species or age categories at once
